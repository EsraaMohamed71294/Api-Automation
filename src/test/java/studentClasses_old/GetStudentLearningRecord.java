...
//                "on sar.student_id  = cs2.student_id and sar.student_access_right_session_id = ser.session_id and sar.student_access_right_class_id = cs2.class_id join educational_resources er  \n" +
...
//            session_id= get_data_to_get_learning_record.getString("student_access_right_session_id");
//            class_id= get_data_to_get_learning_record.getString("student_access_right_class_id");
