...
//    Response Create_Session_for_block1;
//    Response Create_Session_for_block2;
//    Response Create_fullyPaidClass;
//    String class_block1_price= "20";
//    String class_block2_price="30";
//    String body_for_pay_full_class;
//    String subject = "872198392582";
//
...
//                "\"class_payment_option_id\":2,\"class_block_count\":2,\"class_seats_limit\":10,\"is_test_class\":true,\"class_start_date\":\"2025-01-28T00:00:00Z\",\"class_end_date\":\"2027-12-28T00:00:00Z\"," +
//                "\"class_semester_localization_key\":\"First_Term\",\"class_type\":\"ClassType\",\"subjects\":[{\"subject_id\":872198392582,\"class_subject_retail_price\":null," +
//                "\"class_subject_discounted_price\":5,\"class_subject_session_price\":10,\"blocks\":[{\"class_block_number\":1,\"class_block_retail_price\":"+class_block1_price+"}," +
//                "{\"class_block_number\":2,\"class_block_retail_price\":"+class_block2_price+"}]}]," +
...
//                "\"session_end_date\":\"2025-03-01T20:00:00Z\",\"session_duration_in_minutes\":120,\"educator_id\":"+ EducatorId +"," +
//                "\"meta_session_id\":123456789012,\"session_order\":1,\"is_test_session\":true,\"classes_subjects\":[{\"class_id\":"+ Class_ID +"," +
//                "\"subject_id\":"+ subject +",\"block_number\":2}]}";
//
//        System.out.println("valid_body_create_session_for_block_1 " +create_session_for_block_1 +" valid_body_create_session_for_block_2 "+create_session_for_block_2);
//
//        Create_Session_for_block1 = test.sendRequest("POST", "/admin/sessions", create_session_for_block_1, data_of_admin.Admin_Token);
//        Create_Session_for_block2 = test.sendRequest("POST", "/admin/sessions", create_session_for_block_2, data_of_admin.Admin_Token);
//
//        return Class_ID ;
//    }
//    public  Long Create_full_paid_class(){
//        educator.Create_Educator();
//        EducatorId = educator.Educator_ID;
//        System.out.println("educator " +EducatorId);
//        System.out.println("class" +classTitle);
//        body_for_pay_full_class = "{\"class_title\":\""+ classTitle +"\",\"meta_class_id\":785157898183,\"class_order\":1," +
//                "\"class_description\":\"This class provides an introduction to programming concepts.\",\"class_public_listing_date\":\"2024-01-28T00:00:00Z\"," +
//                "\"class_public_delist_date\":\"2025-01-23T00:00:00Z\",\"class_enrollment_end_date\":\"2025-01-30T00:00:00Z\",\"class_archive_date\":\"2025-01-22T00:00:00Z\",\"" +
//                "class_payment_option_id\":1,\"class_block_count\":null,\"class_seats_limit\":10,\"is_test_class\":true,\"class_start_date\":\"2025-01-28T00:00:00Z\"," +
//                "\"class_end_date\":\"2025-12-28T00:00:00Z\",\"class_semester_localization_key\":\"First_Term\",\"class_type\":\"ClassType\",\"subjects\":[{\"subject_id\":"+subject+"," +
...
//
//        Create_fullyPaidClass = test.sendRequest("POST", "/admin/classes", body_for_pay_full_class, data_of_admin.Admin_Token);
//        return Class_ID = Create_fullyPaidClass.then().extract().path("class_id");
//    }
//
...
//        class_block1_price="10000000";
//        class_block2_price="10000000";
//        Create_Class_BlockPayment();
//        pathParams.put("class_id",Class_ID);
//        pathParams.put("student_id",student_id);
//        EnrollStudent =  test.sendRequest("POST","/students/{student_id}/classes/{class_id}/enroll",null,user_token);
