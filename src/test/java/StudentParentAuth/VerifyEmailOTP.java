...
public class VerifyEmailOTP {
    ...
    public void get_Student_OTP_from_database() throws SQLException {
        ResultSet resultSet = Connect.Connect_to_OTP_Database("select \"Email\" ,\"Otp\" ,\"IsVerified\"  from \"UserMailOtp\" umo where \"Email\" ='test.automation@nagwa.com'\n");
    ...
    public void Validate_Response_of_verify_Student_OTP() {
        ...
        String Message = (Verify_Student_OTP.then().extract().path("message_id")).toString();
        ...
        if (Message == "2001"){
            Verify_Student_OTP.then()
                ...
                .body("message", hasToString("Existing user authenticated."),"message_id",equalTo(2001),
                        "data.email",hasToString(studentEmail),"data.first_name",hasToString(studentFirstName),"data.last_name",hasToString(studentLastName),
