...
public class unlockSession {
    ...
    public void get_classes_data_from_database()throws SQLException {
        ...
        while (resultSet_of_unlocked_session.next()) {
            unlockedSession = resultSet_of_unlocked_session.getString("session_id");
            class_id_of_unlocked_session = resultSet_of_unlocked_session.getString("class_id");
        }
//
        ...
        while (resultSet_of_expensive_session.next()) {
            ...
            class_id_for_join_session= resultSet_of_expensive_session.getString("class_id");
        }
    ...
    public void Unlock_Session() {
        System.out.println(fully_Paid_class + "  "+ fully_Paid_class_Session );
